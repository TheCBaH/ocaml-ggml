...
module Opt (F : Ctypes.FOREIGN) = struct
  open F
  open Types_generated
  ...
  let dataset_free = foreign (ns "opt_dataset_free") (Opt.opt_dataset_t @-> returning void)
  ...
  let dataset_ndata = foreign (ns "opt_dataset_ndata") (Opt.opt_dataset_t @-> returning int64_t)

  (** [dataset_data dataset] returns the underlying tensor that stores the data. Shape = [ne_datapoint, ndata].
      - [dataset] The dataset.
      - returns The data tensor. *)
  let dataset_data = foreign (ns "opt_dataset_data") (Opt.opt_dataset_t @-> returning tensor)
  ...
  let dataset_labels = foreign (ns "opt_dataset_labels") (Opt.opt_dataset_t @-> returning tensor)
  ...
  let dataset_get_batch =
    foreign (ns "opt_dataset_get_batch") (Opt.opt_dataset_t @-> tensor @-> tensor @-> int64_t @-> returning void)
  ...
  let dataset_get_batch_host =
    foreign (ns "opt_dataset_get_batch_host")
  ...
  let get_default_optimizer_params =
    foreign (ns "opt_get_default_optimizer_params") (ptr void @-> returning Opt.OptimizerParams.t)
  ...
  let get_constant_optimizer_params =
    foreign (ns "opt_get_constant_optimizer_params") (ptr void @-> returning Opt.OptimizerParams.t)
  ...
  let default_params =
    foreign (ns "opt_default_params") (backend_sched_t @-> Opt.loss_type @-> returning Opt.opt_params_t)
  ...
  let init = foreign (ns "opt_init") (Opt.opt_params_t @-> returning opt_context)

  (** [free opt_ctx] frees the memory associated with an optimization context.
      - [opt_ctx] The optimization context to free. *)
  let free = foreign (ns "opt_free") (opt_context @-> returning void)
  ...
  let reset = foreign (ns "opt_reset") (opt_context @-> bool @-> returning void)
  ...
  let inputs = foreign (ns "opt_inputs") (opt_context @-> returning tensor)
  ...
  let prepare_alloc =
    foreign (ns "opt_prepare_alloc") (opt_context @-> context @-> cgraph @-> tensor @-> tensor @-> returning void)
  ...
  let alloc = foreign (ns "opt_alloc") (opt_context @-> bool @-> returning void)
  ...
  let eval = foreign (ns "opt_eval") (opt_context @-> Opt.opt_result_opt_t @-> returning void)
